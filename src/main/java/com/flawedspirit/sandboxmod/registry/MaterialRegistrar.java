...
public class MaterialRegistrar {
	...
	public static void registerMaterials() {
		experimentiumArmorMaterial = EnumHelper.addArmorMaterial("EXPERIMENTIUM", SandboxMod.MODID + ":experimentium", 42, new int[]{3, 6, 8, 3}, 30, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3f);
